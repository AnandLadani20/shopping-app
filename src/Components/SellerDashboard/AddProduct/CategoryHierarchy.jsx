...
const CategoryHierarchy = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://cyan-feet-retire.loca.lt/ecommerce/category/getMainCategories")
      .then((res) => res.json())
      .then((data) => {
        setListItem(data)
  ...
  const handleSubCategory = async (item) => {
    ...
    try {
      const response = await fetch(`https://cyan-feet-retire.loca.lt/ecommerce/category/getChildCategories?browsePath=${item.browsePath}/${item.categoryId}`);
  ...
  const handleSubOfSubcategory = async (subItem) => {
    ...
    try {
      const response = await fetch(`https://cyan-feet-retire.loca.lt/ecommerce/category/getChildCategories?browsePath=${subItem.browsePath}/${subItem.categoryId}`);
  ...
  const handleThirdSubcategory = async (thirdsubItem) => {
    ...
    try {
      const response = await fetch(`https://cyan-feet-retire.loca.lt/ecommerce/category/getChildCategories?browsePath=${thirdsubItem.browsePath}/${thirdsubItem.categoryId}`);
  ...
  const handleFourthSubcategory = async (fouthsubItem) => {
    ...
    try {
      const response = await fetch(`https://cyan-feet-retire.loca.lt/ecommerce/category/getChildCategories?browsePath=${fouthsubItem.browsePath}/${fouthsubItem.categoryId}`);
  ...
  const handleFifthSubcategory = async (fifthsubItem) => {
    ...
    try {
      const response = await fetch(`https://cyan-feet-retire.loca.lt/ecommerce/category/getChildCategories?browsePath=${fifthsubItem.browsePath}/${fifthsubItem.categoryId}`);
